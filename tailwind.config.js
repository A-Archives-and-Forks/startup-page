...
module.exports = {
  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        'google-icon': "url('/src/assets/icons/google.svg')",
        'duck-icon': "url('/src/assets/icons/duck.svg')",
        'wolfram-icon': "url('/src/assets/icons/wolfram.svg')",
        'stack-icon': "url('/src/assets/icons/stack.svg')",
        'sun-icon': "url('/src/assets/icons/sun.svg')",
        'sun-cloud-icon': "url('/src/assets/icons/sun-cloud.svg')",
        'wind-icon': "url('/src/assets/icons/wind.svg')",
        'humidity-icon': "url('/src/assets/icons/humidity.svg')",
      },
    },
  },
};
